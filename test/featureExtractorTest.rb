...
* 5D <補文ト><カ><助詞><用言:動><係:未格><レベル:B><並キ:述:&ST:3.0&&&レベル:強><区切:3-5><ID:〜か><格要素><連用要素><動態述語><敬語:丁寧表現><正規化代表表記:知る/しる><主辞代表表記:知る/しる><並列類似度:1.258>
+ 5D <補文ト><カ><助詞><用言:動><係:未格><レベル:B><並キ:述:&ST:3.0&&&レベル:強><区切:3-5><ID:〜か><格要素><連用要素><動態述語><敬語:丁寧表現><正規化代表表記:知る/しる><用言代表表記:知る/しる><時制-未来><格関係0:ガ:君><格関係3:ヲ:国><格解析結果:知る/しる:動8:ガ/N/君/0/0/1;ヲ/C/国/3/0/1;ニ/U/-/-/-/-;ト/U/-/-/-/-;デ/U/-/-/-/-;カラ/U/-/-/-/-;ヨリ/U/-/-/-/-;マデ/U/-/-/-/-;時間/U/-/-/-/-;外の関係/U/-/-/-/-;修飾/U/-/-/-/-;ノ/U/-/-/-/-;ヲツウジル/U/-/-/-/-; ニヨル/U/-/-/-/-;トスル/U/-/-/-/-;ガ２/U/-/-/-/-;ニツク/U/-/-/-/-;ニオク/U/-/-/-/-;ヲノゾク/U/-/-/-/-;ヲハジメル/U/-/-/-/-><解析格:ガ>
...
* -1D <文末><体言><用言:判><体言止><レベル:C><区切:5-5><ID:（文末）><裸名詞><提題受:30><主 節><状態述語><正規化代表表記:?/?><主辞代表表記:?/?>
+ -1D <文末><体言><用言:判><体言止><レベル:C><区切:5-5><ID:（文末）><裸名詞><提題受:30><主 節><状態述語><判定詞><名詞項候補><先行詞候補><正規化代表表記:?/?><用言代表表記:?/?><時制-無時制><格関係4:ガ:知って><格解析結果:?/?:判0:ガ/N/知って/4/0/1>
? ? ? 名詞 6 普通名詞 1 * 0 * 0 "疑似代表表記 代表表記:?/? 品詞変更:?-?-?-15-1-0-0" <疑似代表表記><代表表記:?/?><正規化代表表記:?/?><文末><表現文末><品詞変更:?-?-?-15-1-0-0-"疑似代表表記 代表表記:?/?"><品曖-その他><未知語><記英数カ><英記号><記号><名詞相当語><自立><内容語><タグ単位始><文節始><文節主辞>
EOS
ENDOFKNP
    featureExtractor = FeatureExtractor.new("pseudoID", knpLines.split("\n"))
